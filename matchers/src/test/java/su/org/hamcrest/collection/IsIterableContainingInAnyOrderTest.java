...
import su.pernova.matchers.collection.IsIterableContainingInOrderTest.WithValue;

import java.util.Collections;

import static java.util.Arrays.asList;
import static su.pernova.matchers.collection.IsIterableContainingInAnyOrder.containsInAnyOrder;
import static su.pernova.matchers.collection.IsIterableContainingInOrderTest.make;
import static su.pernova.matchers.collection.IsIterableContainingInOrderTest.value;
